...
public class DatabaseOperation {
    ...
    public void CreateTable(String tableName, String... tableColumns) {
    	try {
	    	...
	    	Statement statement = conn.createStatement();
	    	ResultSet TableDoesNotExist = statement.executeQuery("SELECT * FROM information_schema.tables WHERE Table_schema = 'movieticket' AND Table_name = '"+ tableName +"';");
	    	if(!TableDoesNotExist.next()) {
